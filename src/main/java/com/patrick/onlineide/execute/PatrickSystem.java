...
public final class PatrickSystem {

    private PatrickSystem() {
    }

    public final static InputStream in = new PatrickInputStream();

    public final static PrintStream out = new PatrickPrintStream();
